...
// - The `Link` component returns an `<a>` element with `className="navigation__link"` and
//receives the props - `href` which is passed to the `href` attribute of the `<a>` tag and
