...
/*
1: The function calls below do not work properly yet.
 Make the function
...
/*
2: We want to use a function which accepts the radius 
of a circle as a parameter and logs
...
function printCircumference(radius) {
  const radiusForm = 2 * Math.PI * radius;
  const reducednumber = radiusForm.toFixed(2);
...
/*
3: We want to use a function which accepts the width 
and length of a rectangle
   and prints the following text to the console: 
   "The area of the rectangle is ?".
   The function should print the correct area instead 
