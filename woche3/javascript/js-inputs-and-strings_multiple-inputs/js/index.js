...
The value of the first input field is copied 
into the second input field on button click */
...
Implement the following functionality: 
The value of the first input field is copied 
in uppercase into the second input field on button click */
...
/* Sub-Challenge 3
Implement the following functionality: 
The values of the two input fields switch on button click */
...
switchValueButton.addEventListener("click", () => {
  const switchedInput = firstSwitchValueInput.value;
  firstSwitchValueInput.value = secondSwitchValueInput.value;
  secondSwitchValueInput.value = switchedInput;
});
// --^-- write your code here --^--
