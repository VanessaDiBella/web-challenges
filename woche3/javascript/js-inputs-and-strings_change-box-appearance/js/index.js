...
Change the appearance of the box according to the 
values of the sliders (color, border radius, rotation)
...
colorInput.addEventListener("input", () => {
  box.style.backgroundColor = `hsl(${colorInput.value}, 70%, 30%)`;
});
